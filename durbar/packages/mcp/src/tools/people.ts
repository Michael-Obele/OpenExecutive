...
const actions: ActionSpec[] = [
  ...
  },
  {
    name: "list_by_scope",
    description:
      "List the people who hold a given authority scope — e.g. everyone who can sign off hiring.",
    method: "GET",
  ...
  },
  {
    name: "create",
    description:
      "Add a person to the roster. Only `full_name` is required; everything else has a sensible default.",
    method: "POST",
    path: "/people",
    fields: {
      ...personFields,
  ...
  },
  {
    ...
    fields: {
      ...
      clear_on_leave: optionalFlag(
        "True clears `on_leave_until` back to null.",
      ),
    },

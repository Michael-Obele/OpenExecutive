// Buckets chat sessions into date groups for the sidebar / recent-chats list.
// Ported from `packages/ui/src/lib/sessionGroups.ts` — logic unchanged.

import type { SessionSummary } from '$lib/api.js';

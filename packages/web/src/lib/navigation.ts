...
export const PULSE_NAV_ITEM: NavItem = {
	...
	label: 'Pulse',
	icon: 'activity',
	description: "The Executive's memory and heartbeat — what it knows and the rhythm it runs on."
};
...
export const BRIEFING_DESCRIPTION = "Land on a daily brief of what's happened and what needs you.";
...
export const MOBILE_PRIMARY: NavItem[] = [
	...
	},
	{
		...
		label: 'Jobs',
		icon: 'doc',
		description: 'Multi-step workflows that produce a deliverable — board prep, GTM plans, reviews.'
	}
];

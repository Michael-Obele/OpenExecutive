...
<main class="flex-1 min-h-0 overflow-y-auto">
  <div class="mx-auto max-w-3xl px-4 py-8 sm:px-6">
    <h1 class="text-xl font-semibold text-fg">Jobs</h1>
    <p class="mt-2 text-sm text-fg-muted">Multi-step workflows that produce a deliverable — board prep, GTM plans, reviews.</p>
